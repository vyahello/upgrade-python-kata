...
for this number : "Phone => num, Name => name, Address => address"
"""
import re
...
def phone(string: str, number: str) -> str:
    """Returns full phone number by it's number.

    Examples:
        >>> phone(_DIRECTORY, "1-921-512-2222")
...
if __name__ == "__main__":
    print(phone(_DIRECTORY, "1-921-512-2222"))
