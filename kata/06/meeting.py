...
def meeting(members: str) -> str:
    """Sort members by last name.

    Args:
        members: <str> a list of members separated by ';'

    Returns: <str> sorted list of members

    Examples:
        >>> s = "Fred:Corwill;Wilfred:Corwill;Barney:Tornbull;Betty:Tornbull;Bjon:Tornbull;Raphael:Corwill;Alfred:Corwill"
        >>> assert meeting(s) == "(CORWILL, ALFRED)(CORWILL, FRED)(CORWILL, RAPHAEL)(CORWILL, WILFRED)(TORNBULL, BARNEY)(TORNBULL, BETTY)(TORNBULL, BJON)"
    """
    return "".join(
        sorted(
            "({1}, {0})".format(*fullname.split(":"))
            for fullname in members.upper().split(";")
        )
    )
